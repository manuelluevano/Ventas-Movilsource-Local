...
const ServicioForm = ({ ultimoFolio, initialData = {}, onSubmit }) => {
    ...
    const [enFormulario, setEnFormulario] = useState(true);
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md relative">
            ...
            {isSubmitting && (
                <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center z-50 rounded-lg backdrop-blur-sm">
                    <div className="relative">
                        <div className="animate-spin rounded-full h-20 w-20 border-4 border-blue-200 border-t-transparent"></div>
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                            <div className="h-12 w-12 rounded-full bg-gradient-to-r from-orange-500 to-orange-600 animate-pulse"></div>
                        </div>
                    </div>
                    <p className="mt-4 text-white font-medium text-lg flex items-center">
                        Procesando
                        <span className="flex">
                    ...
                    <p className="mt-2 text-blue-100 text-sm">Por favor, espere un momento...</p>
                </div>
            )}
            ...
            {/* Mensaje de error */}
            {submitError && (
                <div className="fixed top-4 right-4 bg-red-500 text-white px-4 py-2 rounded-md shadow-lg z-50 animate-[fadeIn_0.3s_ease-out_forwards]">
